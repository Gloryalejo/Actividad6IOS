...
//Por que no se puede acceder a foo fuera del loop es una variable que solo esta dentro del loop
...
//Por que x se declara fuera del loop por lo que sigue existiendo incluso despues del loop
...
greeting(greeting: "Que hay", name: "Diego") // Output: Hi there, Sara.
greeting(greeting: nil, name: "Sofia")
